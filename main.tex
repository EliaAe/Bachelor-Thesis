...
{\LARGE \sc [ your thesis title ]}\\[0.2\baselineskip] %Title.
\rule{\textwidth}{0.4pt}\vspace*{-\baselineskip}\vspace{3.2pt} %Thin horizontal line.
\rule{\textwidth}{1.6pt}\\[2\baselineskip] %Thick horizontal line.
\scshape %Small caps.
[Bachelor/Master] Thesis\\[2\baselineskip]
Submitted in partial fulfillment of the requirements for \\ the degree of [Select the Title] \par
\vspace*{2\baselineskip}
Author\\
{\Large \textbf{[ your name ]} \\ [8pt]
 }
[ your address ] \\[5pt]
Matriculation Number: \textbf{[ XX-XXX-XXX ]}\\[8pt]
 Email: \texttt{ \href{mailto:yourmail@uzh.ch} {yourmail@uzh.ch} }  \\
...
\fancyfoot[C]{}
\fancyfoot[R]{[ Bachelor/Master Thesis ]}
